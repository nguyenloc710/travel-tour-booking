 ...
 */
@Service
public class ProductContentUseCases {
    ...
    private final ProductContentQueryPort noiDung;
    private final Markets markets;

    public ProductContentUseCases(ProductContentQueryPort noiDung, Markets markets) {
