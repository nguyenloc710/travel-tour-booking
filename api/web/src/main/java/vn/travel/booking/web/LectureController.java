...
import vn.travel.booking.application.lecture.ListLecturesUseCase;
...
public class LectureController implements LecturesApi {
    ...
    private final ListLecturesUseCase listLectures;

    public LectureController(ListLecturesUseCase listLectures) {
