package vn.travel.booking.infrastructure.lecture;

import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.stereotype.Repository;
import vn.travel.booking.application.lecture.LectureQueryPort;
import vn.travel.booking.application.lecture.LectureSummary;
...
@Repository
public class JdbcLectureQueryAdapter implements LectureQueryPort {

    private final JdbcTemplate jdbc;

    public JdbcLectureQueryAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
