...
import vn.travel.booking.application.booking.SeatHoldPort;
 ...
 */
@Repository
public class JdbcSeatHoldAdapter implements SeatHoldPort {

    private final JdbcTemplate jdbc;

    public JdbcSeatHoldAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
