package vn.travel.booking.infrastructure.theme;

import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.stereotype.Repository;
import vn.travel.booking.application.theme.ThemeQueryPort;
import vn.travel.booking.application.theme.ThemeSummary;

import java.util.List;

@Repository
public class JdbcThemeQueryAdapter implements ThemeQueryPort {

    private final JdbcTemplate jdbc;

    public JdbcThemeQueryAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
