...
import vn.travel.booking.application.booking.BookingDraft;
import vn.travel.booking.application.booking.BookingErrors;
import vn.travel.booking.application.booking.BookingView;
import vn.travel.booking.application.booking.BookingWritePort;
...
import vn.travel.booking.domain.pricing.PriceLine;
import vn.travel.booking.domain.pricing.PriceLineKind;
 ...
 */
@Repository
public class JdbcBookingWriteAdapter implements BookingWritePort {
    ...
    public JdbcBookingWriteAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
