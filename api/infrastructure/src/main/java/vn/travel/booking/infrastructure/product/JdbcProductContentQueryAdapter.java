...
import vn.travel.booking.application.product.HotelStay;
import vn.travel.booking.application.product.ItineraryDay;
import vn.travel.booking.application.product.NamedRef;
import vn.travel.booking.application.product.ProductContentQueryPort;
import vn.travel.booking.application.product.ProductType;
import vn.travel.booking.application.product.VisibleProduct;
import vn.travel.booking.domain.departure.BaseDepartureStatus;
import vn.travel.booking.domain.departure.DepartureStatuses;
 ...
 */
@Repository
public class JdbcProductContentQueryAdapter implements ProductContentQueryPort {

    private final JdbcTemplate jdbc;

    public JdbcProductContentQueryAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
