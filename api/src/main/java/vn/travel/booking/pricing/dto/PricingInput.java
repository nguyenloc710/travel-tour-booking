...
public final class PricingInput {
    ...
    public List<PaxLine> paxCopy() {
        return new ArrayList<>(pax);
    }

    public int singleTravellers() {
        return singleTravellers;
    }

    public Money singleSupplementPerPerson() {
        return singleSupplementPerPerson;
    }

    public Money cabinUpgradePerPerson() {
        return cabinUpgradePerPerson;
    }

    public Money departureOriginSurchargePerPerson() {
        return departureOriginSurchargePerPerson;
    }

    public Money insurancePerPerson() {
        return insurancePerPerson;
    }

    public int preTourHotelRooms() {
        return preTourHotelRooms;
    }

    public int preTourHotelNights() {
        return preTourHotelNights;
    }

    public Money preTourHotelPricePerRoomNight() {
        return preTourHotelPricePerRoomNight;
    }

    public Money earlyBirdPerPerson() {
