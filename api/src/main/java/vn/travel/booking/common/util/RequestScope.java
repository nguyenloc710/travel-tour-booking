...
import vn.travel.booking.common.exception.UnsupportedLocaleException;
...
public final class RequestScope {
    ...
    public static String market(String duongDan) {
        return duongDan.toUpperCase(Locale.ROOT);
    }

    public static String locale(String acceptLanguage) {
