...
@IdClass(DestinationMediaEntity.CompositeId.class)
public class DestinationMediaEntity {
    ...
    protected DestinationMediaEntity() {
    }

    public DestinationMediaEntity(UUID destinationId, UUID assetId, short sortOrder) {
    ...
    public static class CompositeId implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(destinationId, other.destinationId) && Objects.equals(assetId, other.assetId);
        }

        @Override
        public int hashCode() {
            return Objects.hash(destinationId, assetId);
        }
    }
}
