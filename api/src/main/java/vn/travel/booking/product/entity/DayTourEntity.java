...
/**
 * Bảng con 1-1 của {@code DAY_TOUR} — docs/12 mục 4.2.
 *
 ...
 */
@Entity
@Table(name = "product_day_tour")
public class DayTourEntity {
    ...
    private Short cutoffHours;

    protected DayTourEntity() {
    }

    public DayTourEntity(UUID productId) {
    ...
    public Short getCutoffHours() {
        return cutoffHours;
    }

    public void setCutoffHours(Short cutoffHours) {
